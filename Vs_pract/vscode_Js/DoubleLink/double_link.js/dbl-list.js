  ...
  _locate(index) {
    ...
    var Navigator = function (startingPosition, startingNode) {
      ...
      this.navigate = function () {
        console.log(
          `Navigating from ${startingPosition} ${index - startingPosition}`
        );
        ...
        for (var i = 0; i < steps; i++) {
          if (forwardDirection) node = node.next;
    ...
    var currentNavigator = new Navigator(
      this._currentIndex === null ? 0 : this._currentIndex,
      this._current
    ); //if this._current===null, this navigator will not be used
